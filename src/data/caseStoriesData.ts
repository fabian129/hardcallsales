...
export const HCS_STORIES: CaseStory[] = [
  ...
  },
  {
    id: "meetly",
    client: "Meetly",
    logo: "/images/logos/logo-meetly.png",
    industry: "Konferens & Företagsevent",
    event: "Över 100 nya avtal och miljonaffärer genom hela säljprocessen",
    teaser: "Sveriges ledande aktör inom möten och event. Utvecklade uppdraget från mötesbokning till hela säljprocessen – från första kontakt till signerade avtal.",
    fullStory: "Meetly är Sveriges ledande aktör inom bokning av konferenser och företagsevent. Vi inledde samarbetet med traditionell mötesbokning, men har sedan utvecklat uppdraget till att omfatta hela säljprocessen – från första kontakt till signerade avtal. Arbetet har omfattat allt från hotellkedjor till ramavtal med miljardbolag, och har resulterat i över 100 nya avtal och affärer värda många miljoner.",
    stats: { primary: "100+ Avtal", secondary: ">10 MSEK", metric: "Hel säljprocess" },
    deliveryDetails: {
      scope: "End-to-end försäljning, mötesbokning och avtalsstängning",
      target: "Koncernledningar, inköpschefer och HR på medelstora och stora svenska bolag",
      outcome: "Över 100 signerade avtal, från ledande hotellkedjor till miljardbolag"
    },
    accent: "#10B981",
    href: "/case",
  },
